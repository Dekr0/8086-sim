...
; mov SS,AX ; IP:0x0c->0x0c,SS:0000->SS:0x2222,
; mov DS,BX ; IP:0x0c->0x0c,DS:0000->DS:0x4444,
; mov ES,CX ; IP:0x0c->0x0c,ES:0000->ES:0x6666,
; mov Al,17 ; IP:0x0c->0x0e,A:0x2222->A:0x2211,
; mov Bh,51 ; IP:0x0e->0x10,B:0x4444->B:0x3344,
; mov Cl,85 ; IP:0x10->0x12,C:0x6666->C:0x6655,
; mov Dh,119 ; IP:0x12->0x14,D:0x8888->D:0x7788,
; mov Ah,Bl ; IP:0x14->0x16,A:0x2211->A:0x4411,
; mov Cl,Dh ; IP:0x16->0x18,C:0x6655->C:0x6677,
; mov SS,AX ; IP:0x18->0x18,SS:0x2222->SS:0x4411,
; mov DS,BX ; IP:0x18->0x18,DS:0x4444->DS:0x3344,
; mov ES,CX ; IP:0x18->0x18,ES:0x6666->ES:0x6677,
; mov SP,SS ; IP:0x18->0x18,SP:0000->SP:0x4411,
; mov BP,DS ; IP:0x18->0x18,BP:0000->BP:0x3344,
; mov SI,ES ; IP:0x18->0x18,SI:0000->SI:0x6677,
; mov DI,DX ; IP:0x18->0x1a,DI:0000->DI:0x7788,
