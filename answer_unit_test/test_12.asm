...
; jmp_addr6: add BX,10 ; IP:0x06->0x09,flags:->A,B:0x3e8->B:0x3f2,
; sub CX,1 ; IP:0x09->0x0c,flags:A->,C:0x03->C:0x02,
; jne jmp_addr6 ; IP:0x0c->0x0e,IP:0x0e->0x06,
; jmp_addr6: add BX,10 ; IP:0x06->0x09,flags:->P,B:0x3f2->B:0x3fc,
; sub CX,1 ; IP:0x09->0x0c,flags:P->,C:0x02->C:0x01,
; jne jmp_addr6 ; IP:0x0c->0x0e,IP:0x0e->0x06,
; jmp_addr6: add BX,10 ; IP:0x06->0x09,flags:->PA,B:0x3fc->B:0x406,
