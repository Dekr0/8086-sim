...
; jmp_addr26: add BX,[BP+SI] ; IP:0x1a->0x1c,flags:->,B:0000->B:0x04,
; sub SI,2 ; IP:0x1c->0x1f,flags:->,SI:0x06->SI:0x04,
; jne jmp_addr26 ; IP:0x1f->0x21,IP:0x21->0x1a,
; jmp_addr26: add BX,[BP+SI] ; IP:0x1a->0x1c,flags:->P,B:0x04->B:0x06,
; sub SI,2 ; IP:0x1c->0x1f,flags:P->,SI:0x04->SI:0x02,
; jne jmp_addr26 ; IP:0x1f->0x21,IP:0x21->0x1a,
; jmp_addr26: add BX,[BP+SI] ; IP:0x1a->0x1c,flags:->P,B:0x06->B:0x06,
...
; IP:0x21
; flags: PZ
; Estimated EU's clock cycles: 135